"""model_builder_custom.py - custom project.

Trains and saves an iris species classifier.
...
Process:
    ...
    - Save the trained model to artifacts/model_custom.joblib.
...
MODEL_PATH: Final[Path] = Path("artifacts") / "model_custom.joblib"
...
def load_data() -> pd.DataFrame:
    """Load the iris dataset and drop rows with missing required values."""
